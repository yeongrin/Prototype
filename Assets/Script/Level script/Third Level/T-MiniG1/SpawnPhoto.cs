...
public class SpawnPhoto : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        timeBetweenWaves = Random.Range(0f, 4f);
    ...
    bool EnemyIsAlive()
    {
        ...
        {
            searchCountdown = 1f;
            if (GameObject.FindGameObjectWithTag("elements3") == null)
    ...
    void SpawnEnemy(Transform _enemy)
    {
        ...
        {
            target = spawnPoints[Random.Range(4, spawnPoints.Length)];
            
        }
        else if (_sp.transform.position.x > 0)
        {
            target = spawnPoints[Random.Range(0, 3)];
